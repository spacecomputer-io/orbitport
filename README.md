...
- **KMS** — multi-tenant Key Management Service backed by OpenBao. Encrypt/decrypt with Transit (`AES_256_GCM96`), sign with Transit (ECDSA, Ed25519, RSA), Ethereum (secp256k1, including EIP-191), use PQC ML-KEM key agreement, and import/export wrapped BYOK material through Transit. See the [`kms`](plugins/pkg/plugin/kms/README.md) plugin.
